...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Image/DetailView.tpl', 46, false),)), $this); ?>
{*
/**
 *
...
{else}50{/if}">
{else}
    <img src="index.php?entryPoint=download&type=<?php echo $this->_tpl_vars['vardef']['linkModule']; ?>
...
<?php else: ?><?php echo $this->_tpl_vars['displayParams']['idName']; ?>
<?php endif; ?>{$fields.width.value}&time={$fields.date_modified.value}" style="max-width: {if !$vardef.width}<?php echo $this->_tpl_vars['vardef']['width']; ?>
{else}200{/if}px;" height="{if !$vardef.height}<?php echo $this->_tpl_vars['vardef']['height']; ?>
{else}50{/if}"> 
{/if}
</span>