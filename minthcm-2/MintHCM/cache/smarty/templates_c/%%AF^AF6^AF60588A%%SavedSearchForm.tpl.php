...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'themes/SuiteP/modules/SavedSearch/SavedSearchForm.tpl', 55, false),array('modifier', 'default', 'themes/SuiteP/modules/SavedSearch/SavedSearchForm.tpl', 86, false),)), $this); ?>
<div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        ...
        <div class="form-item radios">
            <div><input id='sort_order_desc_radio' type='radio' name='sortOrder' value='DESC'
                        ...
                        style="cursor: pointer; cursor: hand"><?php echo $this->_tpl_vars['APP']['LBL_DESCENDING']; ?>
</span></div>
            ...
            <div><input id='sort_order_asc_radio' type='radio' name='sortOrder' value='ASC'
                        ...
                        style="cursor: pointer; cursor: hand"><?php echo $this->_tpl_vars['APP']['LBL_ASCENDING']; ?>
</span>
            </div>
        </div>
    </div>
