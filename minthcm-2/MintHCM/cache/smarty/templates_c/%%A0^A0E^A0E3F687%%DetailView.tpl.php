<?php /* Smarty version 2.6.31, created on 2024-04-24 16:15:31
         compiled from cache/themes/SuiteP/modules/Users/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 48, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 68, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 148, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 977, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1014, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1640, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 141, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1608, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1608, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1608, false),)), $this); ?>
...
<input title="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PREFERENCES']; ?>
" class="button" LANGUAGE="javascript" onclick="if(confirm('<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PREFERENCES_WARNING_USER']; ?>
')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PREFERENCES']; ?>
"/>
<input title="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_HOMEPAGE']; ?>
" class="button" LANGUAGE="javascript" onclick="if(confirm('<?php echo $this->_tpl_vars['MOD']['LBL_RESET_HOMEPAGE_WARNING']; ?>
')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_HOMEPAGE']; ?>
"/>
...
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#"><?php echo $this->_tpl_vars['MOD']['LBL_ADVANCED']; ?>
</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES'] == true): ?>
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#"><?php echo $this->_tpl_vars['MOD']['LBL_USER_ACCESS']; ?>
</a>
</li>
<?php endif; ?>
</ul>
...
<a data-toggle="tab" id="tab1" href="#"><?php echo $this->_tpl_vars['MOD']['LBL_ADVANCED']; ?>
</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES']): ?>
<li role="presentation" class="hidden-xs ">
<a data-toggle="tab" id="tab2" href="#"><?php echo $this->_tpl_vars['MOD']['LBL_USER_ACCESS']; ?>
</a>
</li>
<?php endif; ?>
<?php if ($this->_tpl_vars['config']['enable_action_menu']): ?>
...
<li><input title="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PREFERENCES']; ?>
" class="button" LANGUAGE="javascript" onclick="if(confirm('<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PREFERENCES_WARNING_USER']; ?>
')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PREFERENCES']; ?>
"/></li>
<li><input title="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_HOMEPAGE']; ?>
" class="button" LANGUAGE="javascript" onclick="if(confirm('<?php echo $this->_tpl_vars['MOD']['LBL_RESET_HOMEPAGE_WARNING']; ?>
')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_HOMEPAGE']; ?>
"/></li>
...
<div class="col-xs-12 col-sm-8 detail-view-field " type="name" field="full_name"  >
...
<?php endif; ?> 
<?php $this->assign('type', $this->_tpl_vars['fields']['full_name']['type']); ?>
<span class="sugar_field"><?php echo $this->_tpl_vars['fields']['full_name']['value']; ?>
</span>
<?php if ($this->_tpl_vars['type'] != 'emailbody'): ?>
<input class="vt_formulaSelector vt_Readonly" type="hidden" name="<?php echo $this->_tpl_vars['fields']['full_name']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['full_name']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['full_name']['value']; ?>
"
>
<?php endif; ?>
<?php endif; ?>
...
<?php endif; ?> 
<?php $this->assign('type', $this->_tpl_vars['fields']['user_name']['type']); ?>
<span class="sugar_field"><?php echo $this->_tpl_vars['fields']['user_name']['value']; ?>
</span>
<?php if ($this->_tpl_vars['type'] != 'emailbody'): ?>
<input class="vt_formulaSelector vt_Readonly" type="hidden" name="<?php echo $this->_tpl_vars['fields']['user_name']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['user_name']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['user_name']['value']; ?>
"
data-validation="<?php echo 'AEM(isUnique(user_name,$user_name),\'ERR_USER_NAME_EXISTS_3\')'; ?>
" >
<script>viewTools.form.setFieldRequirement( $( '#<?php echo $this->_tpl_vars['fields']['user_name']['name']; ?>
' ), false, true );</script>
<?php endif; ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['fields']['business_role']['acl'] > 0): ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field " type="enum" field="business_role"  >

<?php if (! $this->_tpl_vars['fields']['business_role']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['business_role']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['business_role']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['business_role']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['business_role']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['business_role']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['business_role']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['business_role']['options'][$this->_tpl_vars['fields']['business_role']['value']]; ?>
