...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Base/EditView.tpl', 46, false),array('modifier', 'default', 'include/SugarFields/Fields/Base/EditView.tpl', 52, false),)), $this); ?>
{*
/**
 *
...
{/if}  
<input class="vt_formulaSelector<?php if ($this->_tpl_vars['vardef']['vt_enforced'] != 'false' && $this->_tpl_vars['vardef']['vt_calculated'] != ''): ?> vt_enforced<?php endif; ?>" type='<?php if (! isset ( $this->_tpl_vars['displayParams']['hidden'] )): ?>text<?php else: ?>hidden<?php endif; ?>' name='<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )): ?><?php echo smarty_function_sugarvar(array('key' => 'name'), $this);?>
