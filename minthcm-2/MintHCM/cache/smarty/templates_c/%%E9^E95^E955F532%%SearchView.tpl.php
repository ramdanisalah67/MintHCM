...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Relate/SearchView.tpl', 46, false),)), $this); ?>
{*
/**
 *
...
"  class="vt_search_relate_input<?php if (empty ( $this->_tpl_vars['displayParams']['class'] )): ?> sqsEnabled <?php else: ?> <?php echo $this->_tpl_vars['displayParams']['class']; ?>
