<?php /* Smarty version 2.6.31, created on 2024-04-24 15:40:03
         compiled from cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 48, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 57, false),array('function', 'counter', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 131, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 124, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 210, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 210, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/OnboardingTemplates/DetailView.tpl', 210, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='OnboardingTemplates'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='OnboardingTemplates'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='OnboardingTemplates'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='OnboardingTemplates'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<input class="button" name="generate_button" id="generate_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_GENERATE_BUTTON']; ?>
" onClick="generateOnboardingOffboarding.init(generateOnboardingOffboarding)" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_GENERATE_BUTTON']; ?>
"/>
<?php if ($this->_tpl_vars['bean']->aclAccess('detail')): ?><?php if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
" class="button" onclick='open_popup("Audit", "600", "400", "&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
&module_name=OnboardingTemplates", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
"><?php endif; ?><?php endif; ?>
</div>                    
<?php endif; ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'OnboardingTemplates'), $this);?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_ASSIGNMENT','module' => 'OnboardingTemplates'), $this);?>
...
<li><input class="button" name="generate_button" id="generate_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_GENERATE_BUTTON']; ?>
" onClick="generateOnboardingOffboarding.init(generateOnboardingOffboarding)" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_GENERATE_BUTTON']; ?>
"/></li>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'OnboardingTemplates'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'OnboardingTemplates'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'OnboardingTemplates'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'OnboardingTemplates'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'OnboardingTemplates'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
