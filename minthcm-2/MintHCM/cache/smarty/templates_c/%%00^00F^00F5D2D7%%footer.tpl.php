<?php /* Smarty version 2.6.31, created on 2024-04-24 15:33:06
...
">
                <p><?php echo $this->_tpl_vars['APP']['LBL_MINT_DESC']; ?>
</p>
                <br>
...
">
            ...
            <div id="copyrightbuttons" class="footer_left">
                <a href="https://minthcm.org/">&copy; <?php echo $this->_tpl_vars['APP']['LBL_MINTHCM_REINVENTED']; ?>
</a>
                <span style="margin-left: 5px; color: #000;">&copy; <?php echo $this->_tpl_vars['APP']['LBL_SUITE_SUPERCHARGED']; ?>
</span>
                <span style="margin-left: 5px; color: #000;">&copy; <?php echo $this->_tpl_vars['APP']['LBL_SUITE_POWERED_BY']; ?>
</span>
            </div>
        </div>
...
<span class="suitepicon suitepicon-action-above"></span> </a>
            <span style="margin-left: 5px; color: #000;">v <?php echo $this->_tpl_vars['MINTHCM_VERSION']; ?>
</span> 
        </div>
    </footer>
    <!-- END Generic Footer -->
