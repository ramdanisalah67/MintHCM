<?php /* Smarty version 2.6.31, created on 2024-04-24 15:37:07
         compiled from cache/themes/SuiteP/modules/Positions/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Positions/SearchForm_basic.tpl', 32, false),array('function', 'math', 'cache/themes/SuiteP/modules/Positions/SearchForm_basic.tpl', 33, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Positions/SearchForm_basic.tpl', 39, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Positions/SearchForm_basic.tpl', 92, false),)), $this); ?>
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Positions'), $this);?>
</label>
					</div>
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['name_basic']['name']; ?>
' 
...
' title=''         accesskey='9'   
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'Positions'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
" value="0"> 
<input class="vt_formulaSelector" type="checkbox" id="<?php echo $this->_tpl_vars['fields']['current_user_only_basic']['name']; ?>
" 
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_securitygroup_leader_name_basic\']={"form":"search_form","method":"query","modules":["SecurityGroups"],"group":"or","field_list":["name","id"],"populate_list":["securitygroup_leader_name_basic","securitygroup_leader_id_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_positions_supervision_name_basic\']={"form":"search_form","method":"query","modules":["Positions"],"group":"or","field_list":["name","id"],"populate_list":["positions_supervision_name_basic","positions_supervision_id_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_onboardingtemplate_name_basic\']={"form":"search_form","method":"query","modules":["OnboardingTemplates"],"group":"or","field_list":["name","id"],"populate_list":["onboardingtemplate_name_basic","onboardingtemplate_id_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_offboardingtemplate_name_basic\']={"form":"search_form","method":"query","modules":["OffboardingTemplates"],"group":"or","field_list":["name","id"],"populate_list":["offboardingtemplate_name_basic","offboardingtemplate_id_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>