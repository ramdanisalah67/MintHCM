<?php /* Smarty version 2.6.31, created on 2024-04-26 09:44:40
         compiled from cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl', 67, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl', 158, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Positions/SearchForm_popup_query_form.tpl', 239, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Positions'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''         accesskey='9'   
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Positions'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='positions_supervision_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSITIONS_SUPERVISION_NAME','module' => 'Positions'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['name']; ?>
"  class="vt_search_relate_input sqsEnabled "   id="<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['positions_supervision_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['positions_supervision_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
        <button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup( "<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"positions_supervision_id_advanced","name":"positions_supervision_name_advanced"}}'; ?>
, "single", true );'><span class="suitepicon suitepicon-action-select"></span></button>    <button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['positions_supervision_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['positions_supervision_id_advanced']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Positions'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'assigned_user_id_advanced','name' => 'assigned_user_id_advanced[]','options' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='favorites_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FAVORITES_FILTER','module' => 'Positions'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
" value="0"> 
<input class="vt_formulaSelector" type="checkbox" id="<?php echo $this->_tpl_vars['fields']['favorites_only_advanced']['name']; ?>
" 
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_securitygroup_leader_name_advanced\']={"form":"popup_query_form","method":"query","modules":["SecurityGroups"],"group":"or","field_list":["name","id"],"populate_list":["securitygroup_leader_name_advanced","securitygroup_leader_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_positions_supervision_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Positions"],"group":"or","field_list":["name","id"],"populate_list":["positions_supervision_name_advanced","positions_supervision_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_onboardingtemplate_name_advanced\']={"form":"popup_query_form","method":"query","modules":["OnboardingTemplates"],"group":"or","field_list":["name","id"],"populate_list":["onboardingtemplate_name_advanced","onboardingtemplate_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_offboardingtemplate_name_advanced\']={"form":"popup_query_form","method":"query","modules":["OffboardingTemplates"],"group":"or","field_list":["name","id"],"populate_list":["offboardingtemplate_name_advanced","offboardingtemplate_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>