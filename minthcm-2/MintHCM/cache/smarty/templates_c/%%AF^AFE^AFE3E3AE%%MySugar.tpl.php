<?php /* Smarty version 2.6.31, created on 2024-04-24 15:33:22
         compiled from themes/SuiteP/tpls/MySugar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getscript', 'themes/SuiteP/tpls/MySugar.tpl', 71, false),array('function', 'counter', 'themes/SuiteP/tpls/MySugar.tpl', 96, false),array('function', 'sugar_getjspath', 'themes/SuiteP/tpls/MySugar.tpl', 269, false),)), $this); ?>
<?php echo '
    <style>
        .menu {
            z-index: 100;
...
?>
            <?php if ($this->_tpl_vars['tabNum'] == 0): ?>
                                <li role="presentation" class="active" data-forced="<?php echo $this->_tpl_vars['dashboardPages'][$this->_tpl_vars['tabNum']]['DMForced']; ?>
">
...
" data-toggle="tab" <?php if (! $this->_tpl_vars['lock_homepage']): ?>ondblclick="renameTab(<?php echo $this->_tpl_vars['tabNum']; ?>
                        ...
                        <?php $this->assign('dashlet_lbl', $this->_tpl_vars['dashboardPages'][$this->_tpl_vars['tabNum']]['pageTitle']); ?>
                        <?php if ($this->_tpl_vars['mod'][$this->_tpl_vars['dashlet_lbl']] != ""): ?><?php echo $this->_tpl_vars['mod'][$this->_tpl_vars['dashlet_lbl']]; ?>
<?php else: ?><?php echo $this->_tpl_vars['dashlet_lbl']; ?>
<?php endif; ?>
                    </a>
...
" data-toggle="tab"  onClick="retrievePage(<?php echo $this->_tpl_vars['tabCountXS']; ?>
                                    ...
                                    <?php $this->assign('dashlet_lbl', $this->_tpl_vars['dashboardPages'][$this->_tpl_vars['tabCountXS']]['pageTitle']); ?>
                                    <?php if ($this->_tpl_vars['mod'][$this->_tpl_vars['dashlet_lbl']] != ""): ?><?php echo $this->_tpl_vars['mod'][$this->_tpl_vars['dashlet_lbl']]; ?>
<?php else: ?><?php echo $this->_tpl_vars['dashlet_lbl']; ?>
<?php endif; ?>
                                </a>
            ...
            <?php else: ?>
                                <li role="presentation" data-forced="<?php echo $this->_tpl_vars['dashboardPages'][$this->_tpl_vars['tabNum']]['DMForced']; ?>
">
