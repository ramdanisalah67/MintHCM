...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Phone/EditView.tpl', 46, false),array('modifier', 'default', 'include/SugarFields/Fields/Phone/EditView.tpl', 57, false),)), $this); ?>
{*
/**
 *
...
<input  class="vt_formulaSelector<?php if ($this->_tpl_vars['vardef']['vt_enforced'] != 'false' && $this->_tpl_vars['vardef']['vt_calculated'] != ''): ?> vt_enforced<?php endif; ?>"  type='text' name='<?php echo $this->_tpl_vars['idname']; ?>
...
' <?php endif; ?>  class="phone vt_formulaSelector<?php if ($this->_tpl_vars['vardef']['vt_enforced'] != 'false' && $this->_tpl_vars['vardef']['vt_calculated'] != ''): ?> vt_enforced<?php endif; ?>" <?php echo $this->_tpl_vars['displayParams']['field']; ?>
