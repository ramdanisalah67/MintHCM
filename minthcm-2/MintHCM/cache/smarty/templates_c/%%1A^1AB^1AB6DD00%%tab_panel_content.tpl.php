<?php /* Smarty version 2.6.31, created on 2024-04-24 15:34:29
         compiled from themes/SuiteP/include/EditView/tab_panel_content.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'themes/SuiteP/include/EditView/tab_panel_content.tpl', 5, false),array('function', 'sugar_field', 'themes/SuiteP/include/EditView/tab_panel_content.tpl', 116, false),array('function', 'sugar_evalcolumn', 'themes/SuiteP/include/EditView/tab_panel_content.tpl', 121, false),)), $this); ?>
...
?>
                ...
                {capture name="field_name" assign="field_name"}<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
{/capture}
                    ...
                    <?php if ($this->_tpl_vars['fieldCount'] < $this->_foreach['colIteration']['total'] && $this->_tpl_vars['addressCount'] < 1 && ! empty ( $this->_tpl_vars['colData']['field']['name'] ) && empty ( $this->_tpl_vars['colData']['field']['hideIf'] )): ?>
                        ...
                        <?php if ($this->_foreach['colIteration']['total'] > 1 && $this->_tpl_vars['colData']['colspan'] != 3): ?>
                            ...
                            <?php if (( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['required'] && ( ! isset ( $this->_tpl_vars['colData']['field']['displayParams']['required'] ) || $this->_tpl_vars['colData']['field']['displayParams']['required'] ) ) || ( isset ( $this->_tpl_vars['colData']['field']['displayParams']['required'] ) && $this->_tpl_vars['colData']['field']['displayParams']['required'] )): ?>
                                    {*<!-- MintHCM #87912 Start -->*}
                                    <div class="col-xs-12 col-sm-4 label bold_required_field" data-label="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['vname']; ?>
">
                                    {*<!-- MintHCM #87912 End -->*}
                                <?php else: ?>
...
">
                            ...
                            <?php else: ?>
                                    <?php if (( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['required'] && ( ! isset ( $this->_tpl_vars['colData']['field']['displayParams']['required'] ) || $this->_tpl_vars['colData']['field']['displayParams']['required'] ) ) || ( isset ( $this->_tpl_vars['colData']['field']['displayParams']['required'] ) && $this->_tpl_vars['colData']['field']['displayParams']['required'] )): ?>
                                        {*<!-- MintHCM #87912 Start -->*}
                                            <div class="col-xs-12 col-sm-2 label bold_required_field" data-label="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['vname']; ?>
">
                                            {*<!-- MintHCM #87912 End -->*}
                                        <?php else: ?>
