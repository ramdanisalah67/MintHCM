<?php /* Smarty version 2.6.31, created on 2024-04-24 16:49:09
         compiled from modules/ACLRoles/EditAllBody.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/ACLRoles/EditAllBody.tpl', 47, false),array('function', 'html_options', 'modules/ACLRoles/EditAllBody.tpl', 105, false),)), $this); ?>
...
<?php $this->assign('ACL_HEADER_DISPLAYED', 'false'); ?>
<?php $_from = $this->_tpl_vars['CATEGORIES']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['CATEGORY_NAME'] => $this->_tpl_vars['TYPES']):
?>
<?php if ($this->_tpl_vars['ACL_HEADER_DISPLAYED'] == 'false'): ?>
    <?php $this->assign('ACL_HEADER_DISPLAYED', 'true'); ?>
