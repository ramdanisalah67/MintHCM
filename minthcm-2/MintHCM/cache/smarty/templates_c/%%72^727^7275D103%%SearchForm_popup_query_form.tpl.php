<?php /* Smarty version 2.6.31, created on 2024-04-24 15:39:54
         compiled from cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl', 125, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl', 518, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Users/SearchForm_popup_query_form.tpl', 599, false),)), $this); ?>
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['first_name_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['last_name_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['user_name_advanced']['name']; ?>
' 
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='business_role_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BUSINESS_ROLE','module' => 'Users'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'business_role_advanced','name' => 'business_role_advanced[]','options' => $this->_tpl_vars['fields']['business_role_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['business_role_advanced']['value']), $this);?>
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['title_advanced']['name']; ?>
' 
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='position_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSITION_NAME','module' => 'Users'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['position_name_advanced']['name']; ?>
"  class="vt_search_relate_input sqsEnabled "   id="<?php echo $this->_tpl_vars['fields']['position_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['position_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['position_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['position_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
        <button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['position_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup( "<?php echo $this->_tpl_vars['fields']['position_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"position_id_advanced","name":"position_name_advanced"}}'; ?>
, "single", true );'><span class="suitepicon suitepicon-action-select"></span></button>    <button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['position_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['position_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['position_id_advanced']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='securitygroup_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SECURITYGROUP_NAME','module' => 'Users'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['name']; ?>
"  class="vt_search_relate_input sqsEnabled "   id="<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['securitygroup_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['securitygroup_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
        <button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup( "<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"securitygroup_id_advanced","name":"securitygroup_name_advanced"}}'; ?>
, "single", true );'><span class="suitepicon suitepicon-action-select"></span></button>    <button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['securitygroup_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['securitygroup_id_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><span class="suitepicon suitepicon-action-clear"></span></button>
        </span>
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['phone_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['address_street_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['email_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['address_city_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['address_state_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['address_postalcode_advanced']['name']; ?>
' 
...
<?php endif; ?>  
<input class="vt_formulaSelector" type='text' name='<?php echo $this->_tpl_vars['fields']['address_country_advanced']['name']; ?>
' 
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_reports_to_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name_advanced","reports_to_id_advanced"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_position_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Positions"],"group":"or","field_list":["name","id"],"populate_list":["position_name_advanced","position_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_candidate_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Candidates"],"group":"or","field_list":["name","id"],"populate_list":["candidate_name_advanced","candidate_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_securitygroup_name_advanced\']={"form":"popup_query_form","method":"query","modules":["SecurityGroups"],"group":"or","field_list":["name","id"],"populate_list":["securitygroup_name_advanced","securitygroup_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_forced_tabs_dashboard_name_advanced\']={"form":"popup_query_form","method":"query","modules":["DashboardManager"],"group":"or","field_list":["name","id"],"populate_list":["forced_tabs_dashboard_name_advanced","forced_tabs_dashboard_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_locked_dashboard_name_advanced\']={"form":"popup_query_form","method":"query","modules":["DashboardManager"],"group":"or","field_list":["name","id"],"populate_list":["locked_dashboard_name_advanced","locked_dashboard_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_users_one_time_default_dashboards_name_advanced\']={"form":"popup_query_form","method":"query","modules":["DashboardManager"],"group":"or","field_list":["name","id"],"populate_list":["users_one_time_default_dashboards_name_advanced","one_time_default_dashboard_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>