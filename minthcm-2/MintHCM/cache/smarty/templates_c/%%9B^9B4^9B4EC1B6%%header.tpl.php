...
<div class="row monthHeader" <?php if (! $this->_tpl_vars['controls']): ?>style="background:#778591"<?php endif; ?>>
        <div class="col-xs-1"><?php echo $this->_tpl_vars['previous']; ?>
</div>
    <div class="col-xs-10 text-center">
            <p style="font-weight:bold; padding-bottom: 15px;"><?php echo $this->_tpl_vars['date_info']; ?>
</p>
        <?php if ($this->_tpl_vars['config']['display_week_number']): ?>
        <p style="font-weight:bold;"><?php echo $this->_tpl_vars['week_info']; ?>
</p>
        <?php endif; ?>
        </div>
