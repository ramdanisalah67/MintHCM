...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Datetime/EditView.tpl', 46, false),)), $this); ?>
{*
/**
 *
...
<span class="dateTime">
    ...
    <input class="date_input vt_formulaSelector<?php if ($this->_tpl_vars['vardef']['vt_enforced'] != 'false' && $this->_tpl_vars['vardef']['vt_calculated'] != ''): ?> vt_enforced<?php endif; ?>" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['idname']; ?>
...
' <?php endif; ?> 
           size="11" maxlength="10" onchange="viewTools.form.blur( $( '#<?php echo $this->_tpl_vars['idname']; ?>
' ) );"
