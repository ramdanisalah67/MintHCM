...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Parent/EditView.tpl', 47, false),)), $this); ?>
{*
/**
 *
...
' class="vt_formulaSelector" {if $locked_field == "parent_type"}disabled{/if} <?php if (! empty ( $this->_tpl_vars['displayParams']['accesskey'] )): ?> accesskey='<?php echo $this->_tpl_vars['displayParams']['accesskey']; ?>
' <?php endif; ?>
...
" class="vt_formulaSelector<?php if ($this->_tpl_vars['vardef']['vt_enforced'] != 'false' && $this->_tpl_vars['vardef']['vt_calculated'] != ''): ?> vt_enforced<?php endif; ?> sqsEnabled" tabindex="<?php echo $this->_tpl_vars['tabindex']; ?>
"
...
"{/if} autocomplete="off" {if $locked_field == "parent_type"}readonly{/if}
...
unset($_smarty_tpl_vars);
 ?>>
<input type="hidden" class="vt_formulaSelector" name="<?php echo smarty_function_sugarvar(array('memberName' => 'vardef.id_name','key' => 'name'), $this);?>
        ...
        <script type="text/javascript">
            if ( typeof (changeParentQS) == 'undefined' ) {
               function changeParentQS( field ) {
                  ...
                  if ( (typeof (disabledModules) != 'undefined' && typeof (disabledModules[new_module]) != 'undefined') || {/literal}"<?php echo $this->_tpl_vars['displayParams']['readOnly']; ?>
" == "readonly" || "{$locked_field}" == "parent_type" ) {* viewTools *}       {literal} {
