...
<input title="{$MOD.LBL_RESET_PREFERENCES}" class="button" LANGUAGE="javascript" onclick="if(confirm('{$MOD.LBL_RESET_PREFERENCES_WARNING_USER}')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record={$fields.id.value}';" type="button" name="password" value="{$MOD.LBL_RESET_PREFERENCES}"/>
<input title="{$MOD.LBL_RESET_HOMEPAGE}" class="button" LANGUAGE="javascript" onclick="if(confirm('{$MOD.LBL_RESET_HOMEPAGE_WARNING}')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record={$fields.id.value}';" type="button" name="password" value="{$MOD.LBL_RESET_HOMEPAGE}"/>
...
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">{$MOD.LBL_ADVANCED}</a>
</li>
{if $SHOW_ROLES == true}
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">{$MOD.LBL_USER_ACCESS}</a>
</li>
{/if}
</ul>
</li>
...
<a data-toggle="tab" id="tab1" href="#">{$MOD.LBL_ADVANCED}</a>
</li>
{if $SHOW_ROLES}
<li role="presentation" class="hidden-xs ">
<a data-toggle="tab" id="tab2" href="#">{$MOD.LBL_USER_ACCESS}</a>
</li>
{/if}
{if $config.enable_action_menu}
...
<li><input title="{$MOD.LBL_RESET_PREFERENCES}" class="button" LANGUAGE="javascript" onclick="if(confirm('{$MOD.LBL_RESET_PREFERENCES_WARNING_USER}')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record={$fields.id.value}';" type="button" name="password" value="{$MOD.LBL_RESET_PREFERENCES}"/></li>
<li><input title="{$MOD.LBL_RESET_HOMEPAGE}" class="button" LANGUAGE="javascript" onclick="if(confirm('{$MOD.LBL_RESET_HOMEPAGE_WARNING}')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record={$fields.id.value}';" type="button" name="password" value="{$MOD.LBL_RESET_HOMEPAGE}"/></li>
...
{/if} 
{assign var="type" value=$fields.full_name.type }
<span class="sugar_field">{$fields.full_name.value}</span>
{if $type != "emailbody" }
<input class="vt_formulaSelector vt_Readonly" type="hidden" name="{$fields.full_name.name}" id="{$fields.full_name.name}" value="{$fields.full_name.value}"
>
{/if}
{/if}
...
{/if} 
{assign var="type" value=$fields.user_name.type }
<span class="sugar_field">{$fields.user_name.value}</span>
{if $type != "emailbody" }
<input class="vt_formulaSelector vt_Readonly" type="hidden" name="{$fields.user_name.name}" id="{$fields.user_name.name}" value="{$fields.user_name.value}"
data-validation="{literal}AEM(isUnique(user_name,$user_name),'ERR_USER_NAME_EXISTS_3'){/literal}" >
<script>viewTools.form.setFieldRequirement( $( '#{$fields.user_name.name}' ), false, true );</script>
{/if}
{/if}
...
{if !$fields.business_role.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.business_role.options)}
<input type="hidden" class="sugar_field" id="{$fields.business_role.name}" value="{ $fields.business_role.options }">
{ $fields.business_role.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.business_role.name}" value="{ $fields.business_role.value }">
{ $fields.business_role.options[$fields.business_role.value]}
{/if}
{/if}
