...
<div class="col-xs-12 col-sm-4 label bold_required_field" data-label="LBL_USER_NAME">
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.user_name.name}' 
...
{capture name="field_name" assign="field_name"}first_name{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.first_name.name}' 
...
{capture name="field_name" assign="field_name"}last_name{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.last_name.name}' 
...
{capture name="field_name" assign="field_name"}UserType{/capture}
...
{capture name="field_name" assign="field_name"}photo{/capture}
<div class="col-xs-12 col-sm-12 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{capture name="field_name" assign="field_name"}business_role{/capture}
<div class="col-xs-12 col-sm-12 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>



<div class="col-xs-12 col-sm-2 label" data-label="LBL_BUSINESS_ROLE">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_BUSINESS_ROLE' module='Users'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="business_role" colspan='3' >
{counter name="panelFieldCount" print=false}

{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select class="vt_formulaSelector" name="{$fields.business_role.name}" 
id="{$fields.business_role.name}" 
title=''               
>
{if isset($fields.business_role.value) && $fields.business_role.value != ''}
{html_options options=$fields.business_role.options selected=$fields.business_role.value}
{else}
{html_options options=$fields.business_role.options selected=$fields.business_role.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.business_role.options }
{capture name="field_val"}{$fields.business_role.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.business_role.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.business_role.name}" 
id="{$fields.business_role.name}" 
title=''                      
>
{if isset($fields.business_role.value) && $fields.business_role.value != ''}
...
<input
id="{$fields.business_role.name}-input"
name="{$fields.business_role.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.business_role.name}-image"></button><button type="button"
id="btn-clear-{$fields.business_role.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.business_role.name}-input', '{$fields.business_role.name}'); sync_{$fields.business_role.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
                    SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
                {/literal}
                                ...
                                {literal}
                    (function (){
                    var selectElem = document.getElementById("{/literal}{$fields.business_role.name}{literal}");
                    if (typeof select_defaults == "undefined")
                            select_defaults = [];
                    select_defaults[selectElem.id] = {key:selectElem.value, text:''};
                    //get default
                ...
                {/literal}
                    ...
                    SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.business_role.name}-input');
                    SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.business_role.name}-image');
                    SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.business_role.name}');
                                {literal}
                    function SyncToHidden(selectme){
                    var selectElem = document.getElementById("{/literal}{$fields.business_role.name}{literal}");
                    var doSimulateChange = false;
                    ...
                    //global variable 
                    sync_{/literal}{$fields.business_role.name}{literal} = function(){
                    SyncToHidden();
                    }
                    function syncFromHiddenToWidget(){
                    ...
                    if (selectElem.options[i].value == selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.business_role.name}-input{literal}'))
                                SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value', selectElem.options[i].innerHTML);
                        }
                        }

                        YAHOO.util.Event.onAvailable("{/literal}{$fields.business_role.name}{literal}", syncFromHiddenToWidget);
                {/literal}
...
{capture name="field_name" assign="field_name"}factor_auth{/capture}
<div class="col-xs-12 col-sm-12 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
<input class="vt_formulaSelector" type="checkbox" id="{$fields.factor_auth.name}" 
...
{capture name="field_name" assign="field_name"}employee_status{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{capture name="field_name" assign="field_name"}show_on_employees{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
<input class="vt_formulaSelector" type="checkbox" id="{$fields.show_on_employees.name}" 
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_POSITION_NAME">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_POSITION_NAME' module='Users'}{/capture}
{$label|strip_semicolon}:
...
<script type="text/javascript">
    ...
    </script>{else}{$POSITION_NAME_READONLY}{/if}
</div>
...
{capture name="field_name" assign="field_name"}phone_work{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input  class="vt_formulaSelector"  type='text' name='{$fields.phone_work.name}' id='{$fields.phone_work.name}' size='30' maxlength='50' value='{$value}' title='' tabindex='0'	  class="phone vt_formulaSelector" 
>
</div>
...
{capture name="field_name" assign="field_name"}securitygroup_name{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SECURITYGROUP_NAME' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{counter name="panelFieldCount"  print=false}
{if $IS_ADMIN}
{capture name=idname assign=idname}{$fields.securitygroup_name.name}{/capture}
<input type="text" name="{$fields.securitygroup_name.name}" class="vt_formulaSelector sqsEnabled" tabindex="0" id="{$fields.securitygroup_name.name}" size="" value="{$fields.securitygroup_name.value}" title='' autocomplete="off"  {if $idname == $locked_field}readonly{/if} 	 
>
<input class="vt_formulaSelector" type="hidden" name="{$fields.securitygroup_name.id_name}" 
id="{$fields.securitygroup_name.id_name}" 
value="{$fields.securitygroup_id.value}">
{if $idname != $locked_field}
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.securitygroup_name.name}" id="btn_{$fields.securitygroup_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.securitygroup_name.module}",
600,
400,
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"securitygroup_id","name":"securitygroup_name"}}{/literal},
"single",
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.securitygroup_name.name}" id="btn_clr_{$fields.securitygroup_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField( this.form, '{$fields.securitygroup_name.name}', '{$fields.securitygroup_name.id_name}' ); $( '#{$fields.securitygroup_name.name},#{$fields.securitygroup_name.id_name}' ).blur();"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{/if}
<script type="text/javascript">
        SUGAR.util.doWhen(
                "typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.securitygroup_name.name}']) != 'undefined'",
                enableQS
                );
    </script>{else}{$SG_NAME_READONLY}{/if}
</div>
...
{capture name="field_name" assign="field_name"}phone_mobile{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input  class="vt_formulaSelector"  type='text' name='{$fields.phone_mobile.name}' id='{$fields.phone_mobile.name}' size='30' maxlength='50' value='{$value}' title='' tabindex='0'	  class="phone vt_formulaSelector" 
>
</div>
...
{capture name="field_name" assign="field_name"}reports_to_name{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{counter name="panelFieldCount"  print=false}
{if $IS_ADMIN}
{capture name=idname assign=idname}{$fields.reports_to_name.name}{/capture}
<input type="text" name="{$fields.reports_to_name.name}" class="vt_formulaSelector sqsEnabled" tabindex="0" id="{$fields.reports_to_name.name}" size="" value="{$fields.reports_to_name.value}" title='' autocomplete="off"  {if $idname == $locked_field}readonly{/if} 	 
>
<input class="vt_formulaSelector" type="hidden" name="{$fields.reports_to_name.id_name}" 
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"reports_to_id","last_name":"reports_to_name"}}{/literal},
"single",
true
...
onclick="SUGAR.clearRelateField( this.form, '{$fields.reports_to_name.name}', '{$fields.reports_to_name.id_name}' ); $( '#{$fields.reports_to_name.name},#{$fields.reports_to_name.id_name}' ).blur();"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{/if}
<script type="text/javascript">
        SUGAR.util.doWhen(
...
{capture name="field_name" assign="field_name"}phone_other{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input  class="vt_formulaSelector"  type='text' name='{$fields.phone_other.name}' id='{$fields.phone_other.name}' size='30' maxlength='50' value='{$value}' title='' tabindex='0'	  class="phone vt_formulaSelector" 
>
</div>
...
{capture name="field_name" assign="field_name"}phone_fax{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input  class="vt_formulaSelector"  type='text' name='{$fields.phone_fax.name}' id='{$fields.phone_fax.name}' size='30' maxlength='50' value='{$value}' title='' tabindex='0'	  class="phone vt_formulaSelector" 
>
</div>
...
{capture name="field_name" assign="field_name"}phone_home{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input  class="vt_formulaSelector"  type='text' name='{$fields.phone_home.name}' id='{$fields.phone_home.name}' size='30' maxlength='50' value='{$value}' title='' tabindex='0'	  class="phone vt_formulaSelector" 
>
</div>
...
{capture name="field_name" assign="field_name"}messenger_type{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select class="vt_formulaSelector" name="{$fields.messenger_type.name}" 
...
{capture name="field_name" assign="field_name"}messenger_id{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.messenger_id.name}' 
...
{capture name="field_name" assign="field_name"}address_street{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.address_street.name}' 
...
{capture name="field_name" assign="field_name"}address_city{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.address_city.name}' 
...
{capture name="field_name" assign="field_name"}address_state{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.address_state.name}' 
...
{capture name="field_name" assign="field_name"}address_postalcode{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.address_postalcode.name}' 
...
{capture name="field_name" assign="field_name"}address_country{/capture}
<div class="col-xs-12 col-sm-12 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.address_country.name}' 
...
addToValidate('EditView', 'business_role', 'enum', false,'{/literal}{sugar_translate label='LBL_BUSINESS_ROLE' module='Users' for_js=true}{literal}' );
...
addToValidate('EditView', 'position_name', 'relate', false,'{/literal}{sugar_translate label='LBL_POSITION_NAME' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'position_id', 'id', false,'{/literal}{sugar_translate label='LBL_POSITION_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'candidate_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CANDIDATE_EMPLOYEE_RELATE_FROM_EMPLOYEE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'securitygroup_name', 'relate', false,'{/literal}{sugar_translate label='LBL_SECURITYGROUP_NAME' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'forced_tabs_dashboard_name', 'relate', false,'{/literal}{sugar_translate label='LBL_USERS_FORCED_TABS_DASHBOARDS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'forced_tabs_dashboard_id', 'id', false,'{/literal}{sugar_translate label='LBL_FORCED_TABS_DASHBOARD_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'locked_dashboard_name', 'relate', false,'{/literal}{sugar_translate label='LBL_USERS_LOCKED_DASHBOARDS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'locked_dashboard_id', 'id', false,'{/literal}{sugar_translate label='LBL_LOCKED_DASHBOARD_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'users_one_time_default_dashboards_name', 'relate', false,'{/literal}{sugar_translate label='LBL_USERS_ONE_TIME_DEFAULT_DASHBOARDS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'one_time_default_dashboard_id', 'id', false,'{/literal}{sugar_translate label='LBL_ONE_TIME_DEFAULT_DASHBOARD_ID' module='Users' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'position_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Users' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_POSITION_NAME' module='Users' for_js=true}{literal}', 'position_id' );
addToValidateBinaryDependency('EditView', 'securitygroup_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Users' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SECURITYGROUP_NAME' module='Users' for_js=true}{literal}', 'securitygroup_id' );
