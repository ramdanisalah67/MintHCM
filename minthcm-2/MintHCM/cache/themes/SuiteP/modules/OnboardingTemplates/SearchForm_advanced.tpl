...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='OnboardingTemplates'}</label>
                            </div>
            <div class="form-item">
...
<input class="vt_formulaSelector" type='text' name='{$fields.name_advanced.name}' 
       ...
       value='{$value}' title=''         accesskey='9'   
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='position_name_advanced'>{sugar_translate label='LBL_POSITION_NAME' module='OnboardingTemplates'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.position_name_advanced.value) <= 0}
    {assign var="value" value=$fields.position_name_advanced.default_value }
{else}
    {assign var="value" value=$fields.position_name_advanced.value }
{/if}  
<input class="vt_formulaSelector" type='text' name='{$fields.position_name_advanced.name}' 
       id='{$fields.position_name_advanced.name}' size='30' 
       ...
       value='{$value}' title=''          
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='OnboardingTemplates'}</label>
                            </div>
            <div class="form-item">
