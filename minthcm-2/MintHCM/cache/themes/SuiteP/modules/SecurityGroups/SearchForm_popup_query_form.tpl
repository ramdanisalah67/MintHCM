...
<span class="dateTime">
    ...
    <input class="date_input vt_formulaSelector" autocomplete="off" type="text" name="{$fields.date_entered_advanced.name}" id="{$fields.date_entered_advanced.name}" value="{$date_value}" title=''  tabindex='0'  
           size="11" maxlength="10" onchange="viewTools.form.blur( $( '#{$fields.date_entered_advanced.name}' ) );"
                                                   >
...
<span class="dateTime">
    ...
    <input class="date_input vt_formulaSelector" autocomplete="off" type="text" name="{$fields.date_modified_advanced.name}" id="{$fields.date_modified_advanced.name}" value="{$date_value}" title=''  tabindex='0'  
           size="11" maxlength="10" onchange="viewTools.form.blur( $( '#{$fields.date_modified_advanced.name}' ) );"
                                                   >
