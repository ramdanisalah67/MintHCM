...
{capture name="field_name" assign="field_name"}date_due{/capture}
<div class="col-xs-12 col-sm-6 edit-view-row-item" {if $fields.$field_name.acl == 0}style="display: none;"{/if}>
...
<tr valign="middle">
<td nowrap class="dateTimeComboColumn">
<input autocomplete="off" type="text" id="{$fields.date_due.name}_date" value="{$fields[$fields.date_due.name].value}" size="11" maxlength="10" title='' tabindex="0" onblur="combo_{$fields.date_due.name}.update();" onchange="combo_{$fields.date_due.name}.update();  viewTools.form.blur( $( '#{$fields.date_due.name}' ) );"                      class="datetimecombo_date vt_formulaSelector"
>
...
<input type="hidden" class="vt_formulaSelector DateTimeCombo" id="{$fields.date_due.name}" name="{$fields.date_due.name}" value="{$fields[$fields.date_due.name].value}" 
>
<script type="text/javascript" src="{sugar_getjspath file="include/SugarFields/Fields/Datetimecombo/Datetimecombo.js"}"></script>
<script type="text/javascript">
...
{capture name="field_name" assign="field_name"}priority{/capture}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select class="vt_formulaSelector" name="{$fields.priority.name}" 
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"form_SubpanelQuickCreate_Tasks","field_to_name_array":{"id":"assigned_user_id","user_name":"assigned_user_name"}}{/literal},
"single",
true
