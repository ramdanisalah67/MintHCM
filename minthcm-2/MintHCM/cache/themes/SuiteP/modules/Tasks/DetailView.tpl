...
{/if} 
{assign var="type" value=$fields.date_start.type }
<span class="sugar_field">{$fields.date_start.value}</span>
{if $type != "emailbody" }
<input class="vt_formulaSelector vt_Readonly" type="hidden" name="{$fields.date_start.name}" id="{$fields.date_start.name}" value="{$fields.date_start.value}"
>
{/if}
{/if}
...
{/if} 
{assign var="type" value=$fields.date_due.type }
<span class="sugar_field">{$fields.date_due.value}</span>
{if $type != "emailbody" }
<input class="vt_formulaSelector vt_Readonly" type="hidden" name="{$fields.date_due.name}" id="{$fields.date_due.name}" value="{$fields.date_due.value}"
>
{/if}
{/if}
