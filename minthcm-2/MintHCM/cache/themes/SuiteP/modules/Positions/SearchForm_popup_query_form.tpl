...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Positions'}</label>
                            </div>
            <div class="form-item">
...
<input class="vt_formulaSelector" type='text' name='{$fields.name_advanced.name}' 
       ...
       value='{$value}' title=''         accesskey='9'   
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='Positions'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='positions_supervision_name_advanced'>{sugar_translate label='LBL_POSITIONS_SUPERVISION_NAME' module='Positions'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.positions_supervision_name_advanced.name}"  class="vt_search_relate_input sqsEnabled "   id="{$fields.positions_supervision_name_advanced.name}" size="" value="{$fields.positions_supervision_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.positions_supervision_id_advanced.name}" value="{$fields.positions_supervision_id_advanced.value}">
<span class="id-ff multiple">
        <button type="button" name="btn_{$fields.positions_supervision_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup( "{$fields.positions_supervision_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"positions_supervision_id_advanced","name":"positions_supervision_name_advanced"}}{/literal}, "single", true );'><span class="suitepicon suitepicon-action-select"></span></button>    <button type="button" name="btn_clr_{$fields.positions_supervision_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.positions_supervision_name_advanced.name}.value = ''; this.form.{$fields.positions_supervision_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        </span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Positions'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='favorites_only_advanced'>{sugar_translate label='LBL_FAVORITES_FILTER' module='Positions'}</label>
                            </div>
            <div class="form-item">
...
<input class="vt_formulaSelector" type="checkbox" id="{$fields.favorites_only_advanced.name}" 
