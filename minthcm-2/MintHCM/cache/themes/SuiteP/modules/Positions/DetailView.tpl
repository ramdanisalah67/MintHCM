...
<div class="buttons">
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Positions'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='EditView';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Edit" id="edit_button" value="{$APP.LBL_EDIT_BUTTON_LABEL}">{/if} 
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Positions'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='{$id}';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}" id="duplicate_button">{/if} 
...
{sugar_translate label='LBL_SHOW_MORE_INFORMATION' module='Positions'}
</a>
</li>
</ul>
</li>
...
<li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=Positions", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li>
</ul>        </li>
...
{if $fields.securitygroup_leader_name.acl > 0}
...
{if !$fields.securitygroup_leader_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.securitygroup_leader_id.value)}
{capture assign="detail_url"}index.php?module=SecurityGroups&action=DetailView&record={$fields.securitygroup_leader_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="securitygroup_leader_id" class="sugar_field" data-id-value="{$fields.securitygroup_leader_id.value}">{$fields.securitygroup_leader_name.value}</span>
{if !empty($fields.securitygroup_leader_id.value)}</a>{/if}
{/if}
...
{if $fields.positions_supervision_name.acl > 0}
...
{if !$fields.positions_supervision_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.positions_supervision_id.value)}
{capture assign="detail_url"}index.php?module=Positions&action=DetailView&record={$fields.positions_supervision_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="positions_supervision_id" class="sugar_field" data-id-value="{$fields.positions_supervision_id.value}">{$fields.positions_supervision_name.value}</span>
{if !empty($fields.positions_supervision_id.value)}</a>{/if}
{/if}
...
{if $fields.offboardingtemplate_name.acl > 0}
...
{if !$fields.offboardingtemplate_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.offboardingtemplate_id.value)}
{capture assign="detail_url"}index.php?module=OffboardingTemplates&action=DetailView&record={$fields.offboardingtemplate_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="offboardingtemplate_id" class="sugar_field" data-id-value="{$fields.offboardingtemplate_id.value}">{$fields.offboardingtemplate_name.value}</span>
{if !empty($fields.offboardingtemplate_id.value)}</a>{/if}
{/if}
...
{if $fields.onboardingtemplate_name.acl > 0}
...
{if !$fields.onboardingtemplate_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.onboardingtemplate_id.value)}
{capture assign="detail_url"}index.php?module=OnboardingTemplates&action=DetailView&record={$fields.onboardingtemplate_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="onboardingtemplate_id" class="sugar_field" data-id-value="{$fields.onboardingtemplate_id.value}">{$fields.onboardingtemplate_name.value}</span>
{if !empty($fields.onboardingtemplate_id.value)}</a>{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_ENTERED' module='Positions'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_MODIFIED' module='Positions'}{/capture}
{$label|strip_semicolon}:
</div>
