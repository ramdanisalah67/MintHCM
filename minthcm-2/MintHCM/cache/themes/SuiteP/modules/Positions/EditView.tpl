...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"securitygroup_leader_id","name":"securitygroup_leader_name"}}{/literal},
"single",
true
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"positions_supervision_id","name":"positions_supervision_name"}}{/literal},
"single",
true
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"offboardingtemplate_id","name":"offboardingtemplate_name"}}{/literal},
"single",
true
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"onboardingtemplate_id","name":"onboardingtemplate_name"}}{/literal},
"single",
true
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='Positions'}{/capture}
{$label|strip_semicolon}:
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'status', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'securitygroup_leader_name', 'relate', false,'{/literal}{sugar_translate label='LBL_SECURITYGROUPS_LEADER_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'positions_supervision_name', 'relate', false,'{/literal}{sugar_translate label='LBL_POSITIONS_SUPERVISION_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'positions_supervision_id', 'id', false,'{/literal}{sugar_translate label='LBL_POSITIONS_SUPERVISION_ID' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'onboardingtemplate_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ONBOARDINGTEMPLATE_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'onboardingtemplate_id', 'id', false,'{/literal}{sugar_translate label='LBL_ONBOARDINGTEMPLATE_ID' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'offboardingtemplate_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OFFBOARDINGTEMPLATE_NAME' module='Positions' for_js=true}{literal}' );
addToValidate('EditView', 'offboardingtemplate_id', 'id', false,'{/literal}{sugar_translate label='LBL_OFFBOARDINGTEMPLATE_ID' module='Positions' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Positions' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='Positions' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'securitygroup_leader_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Positions' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SECURITYGROUPS_LEADER_NAME' module='Positions' for_js=true}{literal}', 'securitygroup_leader_id' );
addToValidateBinaryDependency('EditView', 'positions_supervision_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Positions' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_POSITIONS_SUPERVISION_NAME' module='Positions' for_js=true}{literal}', 'positions_supervision_id' );
addToValidateBinaryDependency('EditView', 'onboardingtemplate_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Positions' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ONBOARDINGTEMPLATE_NAME' module='Positions' for_js=true}{literal}', 'onboardingtemplate_id' );
addToValidateBinaryDependency('EditView', 'offboardingtemplate_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Positions' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_OFFBOARDINGTEMPLATE_NAME' module='Positions' for_js=true}{literal}', 'offboardingtemplate_id' );
