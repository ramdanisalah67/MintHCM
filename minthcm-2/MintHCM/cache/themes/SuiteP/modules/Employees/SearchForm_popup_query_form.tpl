...
{html_options id='employee_status_advanced' name='employee_status_advanced[]' options=$fields.employee_status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.employee_status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='position_name_advanced'>{sugar_translate label='LBL_POSITION_NAME' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input class="vt_formulaSelector" type='text' name='{$fields.phone_advanced.name}' 
       ...
       value='{$value}' title=''          
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='securitygroup_name_advanced'>{sugar_translate label='LBL_SECURITYGROUP_NAME' module='Employees'}</label>
                            </div>
            <div class="form-item">
