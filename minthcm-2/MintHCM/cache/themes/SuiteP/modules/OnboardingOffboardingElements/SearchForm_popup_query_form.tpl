...
{/if}  
<input type='text' name='{$fields.days_from_start_advanced.name}' 
    id='{$fields.days_from_start_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='user_name_advanced'>{sugar_translate label='LBL_USERS_NAME' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.user_name_advanced.name}"  class="vt_search_relate_input sqsEnabled "   id="{$fields.user_name_advanced.name}" size="" value="{$fields.user_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.user_id_advanced.name}" value="{$fields.user_id_advanced.value}">
<span class="id-ff multiple">
        <button type="button" name="btn_{$fields.user_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup( "{$fields.user_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"user_id_advanced","name":"user_name_advanced"}}{/literal}, "single", true );'><span class="suitepicon suitepicon-action-select"></span></button>    <button type="button" name="btn_clr_{$fields.user_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.user_name_advanced.name}.value = ''; this.form.{$fields.user_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        </span>
