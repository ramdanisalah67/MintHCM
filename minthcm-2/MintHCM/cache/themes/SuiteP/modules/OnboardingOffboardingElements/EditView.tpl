...
{counter name="panelFieldCount"  print=false}
<input tabindex="0"  id="task_duration_hours" name="task_duration_hours" size="2" maxlength="2" type="text" value="{$fields.task_duration_hours.value}"/>{$fields.task_duration_minutes.value}&nbsp;<span class="dateFormat">{$MOD.LBL_HOURS_MINUTES}</span>
</div>
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"securitygroup_unit_id","name":"securitygroup_unit_name"}}{/literal},
"single",
true
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"EditView","field_to_name_array":{"id":"user_id","name":"user_name"}}{/literal},
"single",
true
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='OnboardingOffboardingElements'}{/capture}
{$label|strip_semicolon}:
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'kind_of_element', 'enum', true,'{/literal}{sugar_translate label='LBL_KIND_OF_ELEMENT' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'type', 'enum', true,'{/literal}{sugar_translate label='LBL_TYPE' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'task_duration_hours', 'int', true,'{/literal}{sugar_translate label='LBL_TASK_DURATION_HOURS' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'task_duration_minutes', 'int', false,'{/literal}{sugar_translate label='LBL_TASK_DURATION_MINUTES' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'days_from_start', 'int', true,'{/literal}{sugar_translate label='LBL_DAYS_FROM_START' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'user_name', 'relate', true,'{/literal}{sugar_translate label='LBL_USERS_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'user_id', 'id', false,'{/literal}{sugar_translate label='LBL_USERS_ID' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'securitygroup_unit_name', 'relate', true,'{/literal}{sugar_translate label='LBL_SECURITYGROUP_UNIT_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidate('EditView', 'securitygroup_unit_id', 'id', false,'{/literal}{sugar_translate label='LBL_SECURITYGROUP_UNIT_ID' module='OnboardingOffboardingElements' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='OnboardingOffboardingElements' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='OnboardingOffboardingElements' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'user_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='OnboardingOffboardingElements' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_USERS_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}', 'user_id' );
addToValidateBinaryDependency('EditView', 'securitygroup_unit_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='OnboardingOffboardingElements' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SECURITYGROUP_UNIT_NAME' module='OnboardingOffboardingElements' for_js=true}{literal}', 'securitygroup_unit_id' );
