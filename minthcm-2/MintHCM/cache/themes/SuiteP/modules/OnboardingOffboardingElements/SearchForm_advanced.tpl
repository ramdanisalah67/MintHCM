...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
...
<input class="vt_formulaSelector" type='text' name='{$fields.name_advanced.name}' 
       ...
       value='{$value}' title=''         accesskey='9'   
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='user_id_advanced'>{sugar_translate label='LBL_USERS_NAME' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='user_id_advanced' name='user_id_advanced[]' options=$fields.user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.user_id_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='employee_id_advanced'>{sugar_translate label='LBL_EMPLOYEE_NAME' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='employee_id_advanced' name='employee_id_advanced[]' options=$fields.employee_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.employee_id_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='kind_of_element_advanced'>{sugar_translate label='LBL_KIND_OF_ELEMENT' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='kind_of_element_advanced' name='kind_of_element_advanced[]' options=$fields.kind_of_element_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.kind_of_element_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_advanced'>{sugar_translate label='LBL_TYPE' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='type_advanced' name='type_advanced[]' options=$fields.type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.type_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='securitygroup_unit_name_advanced'>{sugar_translate label='LBL_SECURITYGROUP_UNIT_NAME' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.securitygroup_unit_name_advanced.name}"  class="vt_search_relate_input sqsEnabled "   id="{$fields.securitygroup_unit_name_advanced.name}" size="" value="{$fields.securitygroup_unit_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.securitygroup_unit_id_advanced.name}" value="{$fields.securitygroup_unit_id_advanced.value}">
<span class="id-ff multiple">
        <button type="button" name="btn_{$fields.securitygroup_unit_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup( "{$fields.securitygroup_unit_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"securitygroup_unit_id_advanced","name":"securitygroup_unit_name_advanced"}}{/literal}, "single", true );'><span class="suitepicon suitepicon-action-select"></span></button>    <button type="button" name="btn_clr_{$fields.securitygroup_unit_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.securitygroup_unit_name_advanced.name}.value = ''; this.form.{$fields.securitygroup_unit_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        </span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='days_from_start_advanced'>{sugar_translate label='LBL_DAYS_FROM_START' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.days_from_start_advanced.value) <= 0}
{assign var="value" value=$fields.days_from_start_advanced.default_value }
{else}
{assign var="value" value=$fields.days_from_start_advanced.value }
{/if}

{assign var="id" value=$fields.days_from_start_advanced.name }

{if isset($smarty.request.days_from_start_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.days_from_start_advanced_range_choice}
{else}
...
{html_options options=$fields.days_from_start_advanced.options selected=$starting_choice}
</select>
...
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
    ...
    value='{if empty($smarty.request.range_days_from_start_advanced) && !empty($smarty.request.days_from_start_advanced)}{$smarty.request.days_from_start_advanced}{else}{$smarty.request.range_days_from_start_advanced}{/if}' tabindex='' >
</div>
...
<input type='text' name='start_range_{$id}' 
    ...
    value='{$smarty.request.start_range_days_from_start_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_days_from_start_advanced }' tabindex=''>    
</div> 
</span>
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
...
// filled prior to submitting search form.  It is called from the listener added above.
    ...
    {rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='OnboardingOffboardingElements'}</label>
                            </div>
            <div class="form-item">
