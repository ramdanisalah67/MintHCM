...
<div class="buttons">
{if $bean->aclAccess("save")}<input title="{$APP.LBL_SAVE_BUTTON_TITLE}"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_EmployeeRoles'); disableOnUnloadEditView(); _form.action.value='Save';if(check_form('form_SubpanelQuickCreate_EmployeeRoles'))return SUGAR.subpanelUtils.inlineSave(_form.id, 'EmployeeRoles_subpanel_save_button');return false;" type="submit" name="EmployeeRoles_subpanel_save_button" id="EmployeeRoles_subpanel_save_button" value="{$APP.LBL_SAVE_BUTTON_LABEL}">{/if} 
<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="EmployeeRoles_subpanel_cancel_button" id="EmployeeRoles_subpanel_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
<input title="{$APP.LBL_FULL_FORM_BUTTON_TITLE}" class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_EmployeeRoles'); disableOnUnloadEditView(_form); _form.return_action.value='DetailView'; _form.action.value='EditView'; if(typeof(_form.to_pdf)!='undefined') _form.to_pdf.value='0';" type="submit" name="EmployeeRoles_subpanel_full_form_button" id="EmployeeRoles_subpanel_full_form_button" value="{$APP.LBL_FULL_FORM_BUTTON_LABEL}"> <input type="hidden" name="full_form" value="full_form">
{if $showVCRControl}
...
true,
false,
{literal}{"call_back_function":"viewTools.form.function.set_return","form_name":"form_SubpanelQuickCreate_EmployeeRoles","field_to_name_array":{"id":"assigned_user_id","user_name":"assigned_user_name"}}{/literal},
"single",
true
...
YAHOO.util.Event.onContentReady("form_SubpanelQuickCreate_EmployeeRoles",
    function () {ldelim} initEditView(document.forms.form_SubpanelQuickCreate_EmployeeRoles) {rdelim});
...
{/literal}{literal}
<script type="text/javascript">
addForm('form_SubpanelQuickCreate_EmployeeRoles');addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='EmployeeRoles' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='EmployeeRoles' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_EmployeeRoles', 'status', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='EmployeeRoles' for_js=true}{literal}' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_EmployeeRoles', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='EmployeeRoles' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='EmployeeRoles' for_js=true}{literal}', 'assigned_user_id' );
