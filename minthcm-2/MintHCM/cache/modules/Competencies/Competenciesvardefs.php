<?php 
 $GLOBALS["dictionary"]["Competencies"]=array (
  'table' => 'competencies',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'competencies_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'competencies_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'competencies_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_competencies',
    ...
    array (
      'name' => 'employee_link',
      'type' => 'link',
      'relationship' => 'competencies_employee',
      'vname' => 'LBL_EMPLOYEE',
      'link_type' => 'one',
      'module' => 'Employees',
      'bean_name' => 'Employee',
