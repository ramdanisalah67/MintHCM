<?php 
 $GLOBALS["dictionary"]["Allocations"]=array (
  'table' => 'allocations',
  'audited' => true,
  'inline_edit' => false,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'allocations_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'allocations_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'allocations_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_allocations',
    ...
    array (
      ...
      'vt_validation' => 
      array (
        0 => 'AEM(callCustomApi(Allocations,checkWorkplaceStatus,$workplace_id,$mode),\'LBL_ERR_WORKPLACE_STATUS\')',
        1 => 'AEM(callCustomApi(Allocations,checkWorkplacePeriods,$id,$workplace_id,$mode,$date_from,$date_to),\'LBL_ERR_WORKPLACE_PERIODS\')',
      ),
    ),
    'workplace_id' => 
    array (
